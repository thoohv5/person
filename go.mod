module github.com/thoohv5/person

go 1.21

replace github.com/imdario/mergo v1.0.0 => dario.cat/mergo v1.0.1-0.20230620065459-1475161b8f00
...
require (
	...
	github.com/thoohv5/swagger-ci v0.0.1
