...
var tables = flag.String("t", "", "t: table, Name of service to be registered")
var dir = flag.String("d", "./service.go", "d: dir, Registered file path")
...
func main() {
	...
	for _, table := range strings.Split(*tables, ",") {
		if err := util.RegService(fst, f, table, path); err != nil {
