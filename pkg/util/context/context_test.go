...
func TestContext(t *testing.T) {
	type ctxKey1 struct{}
	type ctxKey2 struct{}
	ctx1 := context.WithValue(context.Background(), ctxKey1{}, "https://github.com/go-common/")
	ctx2 := context.WithValue(context.Background(), ctxKey2{}, "https://go-common.dev/")
	...
	if !reflect.DeepEqual(value1, "https://github.com/go-common/") {
		t.Errorf("expect %v, got %v", "https://github.com/go-common/", value1)
	}
	...
	if !reflect.DeepEqual("https://go-common.dev/", value2) {
		t.Errorf("expect %v, got %v", "https://go-common.dev/", value2)
	}
...
func TestMerge(t *testing.T) {
	...
	cancel()
	ctx1 := context.WithValue(context.Background(), ctxKey1{}, "https://github.com/go-common/")
	ctx2 := context.WithValue(ctx, ctxKey2{}, "https://go-common.dev/")
	...
	if !reflect.DeepEqual(value2, "https://go-common.dev/") {
		t.Errorf("expect %v, got %v", " https://go-common.dev/", value2)
	}
